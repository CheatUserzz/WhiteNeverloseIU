...
if not parentFrame then
    warn("[White IU] NEVERLOSE.Frame not found in CoreGui. [ER1]")
    return
end
...
corner.CornerRadius = UDim.new(0, 12) -- ajusta o raio aqui
corner.Parent = aboutFrame
...
AddInfo("Subscription till: ", "Lifetime", 4, true)

-- Footer
local copyright = Instance.new("TextLabel", aboutFrame)
copyright.Text = "White Menu © 2025"
